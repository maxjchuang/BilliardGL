...
with tempfile.TemporaryDirectory() as directory:
    ...
    assert markdown.count("FAILED (KNOWN)") == 2
    assert "domenech_2023_ball_collision__rubber_lambda2_001_v2 | FAILED (KNOWN)" in markdown
    assert "mathavan_2010_cushion__fig7_experimental_06_v2 | FAILED (KNOWN)" in markdown
