...
MATRIX = ROOT / "physics_models/promotion/full_game_matrix_v4.json"
BUDGET = ROOT / "physics_models/promotion/full_game_performance_budget_v4.json"
BASELINE = ROOT / "physics_models/promotion/full_game_performance_baseline_v4.json"
CSV = ROOT / "physics_models/promotion/full_game_stress_v4.csv"
...
class Phase3V4FullGameRunTests(unittest.TestCase):
    def setUp(self):
    ...
    def test_all_twelve_cases_preserve_complete_v4_traces(self):
