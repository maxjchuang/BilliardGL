...
void drawHelpOverlay(const GameState& state)
{
    ...
    y -= 28.0f;
    drawStringAt(textLeft, y, GLUT_BITMAP_HELVETICA_18, "Left mouse hold       Charge shot");
    y -= 24.0f;
    drawStringAt(textLeft, y, GLUT_BITMAP_HELVETICA_18, "Left mouse release    Hit cue ball");
    y -= 24.0f;
